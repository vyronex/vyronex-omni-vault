            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-16 items-center no-center">
                ...
                <div className="relative order-2 lg:order-1 flex justify-center">
                  ...
                  {/* Store buttons under the phone preview */}
                  <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                    <a href="#" className="inline-flex items-center gap-3 px-5 py-2.5 rounded-2xl bg-card border border-border hover:bg-secondary/80 transition-colors active-press w-full sm:w-auto justify-center">
