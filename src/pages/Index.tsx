            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-16 items-center no-center">
                ...
                <div className="relative order-2 lg:order-1 flex justify-center">
                  ...
                  {/* Store buttons + QR codes under the phone preview */}
                  <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                    <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                      <a href={APP_STORE_URL} className="inline-flex items-center gap-3 px-5 py-2.5 rounded-2xl bg-card border border-border hover:bg-secondary/80 transition-colors active-press flex-1 justify-center sm:justify-start">
                        <svg viewBox="0 0 24 24" className="h-6 w-6 fill-current"><path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.06.75.79.02 1.99-.81 3.56-.69 1.86.13 3.27.8 4.07 1.95-3.4 2.03-2.85 6.35.53 7.74-.7 1.77-1.65 3.52-3.22 5.22zM12.03 7.25c-.08-2.69 2.2-4.99 4.85-5.18.36 3.19-3.05 5.53-4.85 5.18z"/></svg>
                      ...
                      <div className="flex flex-col items-center gap-1">
                        <div className="p-1.5 rounded-xl bg-card border border-border">
                          <QRCodeSVG value={APP_STORE_URL} size={56} fgColor="#ffffff" bgColor="transparent" />
                        </div>
                        <span className="text-[9px] text-muted-foreground uppercase tracking-wider font-bold">Scan</span>
                      </div>
                    </div>
                    <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                      <a href={GOOGLE_PLAY_URL} className="inline-flex items-center gap-3 px-5 py-2.5 rounded-2xl bg-card border border-border hover:bg-secondary/80 transition-colors active-press flex-1 justify-center sm:justify-start">
                      ...
                      <div className="flex flex-col items-center gap-1">
                        <div className="p-1.5 rounded-xl bg-card border border-border">
                          <QRCodeSVG value={GOOGLE_PLAY_URL} size={56} fgColor="#ffffff" bgColor="transparent" />
                        </div>
                        <span className="text-[9px] text-muted-foreground uppercase tracking-wider font-bold">Scan</span>
                      </div>
                    </div>
